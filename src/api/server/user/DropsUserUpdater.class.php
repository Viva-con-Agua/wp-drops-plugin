...
class DropsUserUpdater
{
    ...
    private $optionalUserMetaFields = array('nickname', 'first_name', 'mail_switch', 'pool_lang', 'secondary_nl', 'last_name', 'capabilites', 'mobile', 'residence', 'birthday', 'gender', 'nation', 'city');
