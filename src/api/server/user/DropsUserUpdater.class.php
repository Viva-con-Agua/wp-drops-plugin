...
class DropsUserUpdater
{
    ...
    public function run()
    {
		...
		if (!$this->doUserMetaUpdate($userId)) {
						
			return (new DropsResponse())
				->setCode(400)
				->setContext(__CLASS__)
				->setMessage('Database error during user meta update! Parameters: ' . implode(', ', $this->userData));
    ...
    private function createUserMeta($userId)
    {
        ...
        $userMetaData = array(
            ...
            'use_ssl' => '0',
            'wp_capabilities' => 'a:1:{s:9:"supporter";b:1;}',
            'wp_user_level' => '0',
            ...
            'wp_user-settings' => 'tml1=2&tml0=0&mfold=o&posts_list_mode=list&unfold=0',
            'wp_user-settings-time' => time(),
